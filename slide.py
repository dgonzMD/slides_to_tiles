...
import tiles
import filter # must be the final imported module due to tight circular dependencies.
import config
...
SRC_TRAIN_EXT = config.SRC_TRAIN_EXT
DEST_TRAIN_SUFFIX = config.DEST_TRAIN_SUFFIX
DEST_TRAIN_EXT = config.DEST_TRAIN_EXT
...
#     img_path = get_training_image_path(2)
